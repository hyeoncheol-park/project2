...
<body>
	<div class="container" style="background: #1abc9c">
		...
		<form action="/news/graph.do" method="post" id="test">
			<div class="row">
							...
							<div class="form-group has-success">
								...
								<div class="col-md-11">
									<div class="row">
										...
										<div class="col-xs-9">
											<input type="text" class="form-control"
												placeholder="관련어를 ,(콤마)로 이어서 입력해주세요 ex) 코로나, 피해" title="앞에는 공백문자를 사용할 수 없습니다."
												name="keywords" required="required" id="keywords" pattern="[a-zA-Z가-힣0-9][a-zA-Z가-힣0-9,\s]{0,100}" >
										</div>
									</div>
								</div>
							</div>
